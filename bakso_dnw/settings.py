"""
Django settings for bakso_dnw project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-!!oo55-jg4gf#jf80qm)slxamt@%_)5_o9%k(1brbs#e7c8s8%')
...
if not PRODUCTION:
    ALLOWED_HOSTS += ['.localhost', '127.0.0.1', '192.168.1.242','[::1]',]
...
WSGI_APPLICATION = 'bakso_dnw.wsgi.application'
